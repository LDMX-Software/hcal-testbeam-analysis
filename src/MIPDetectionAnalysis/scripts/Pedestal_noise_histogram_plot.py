...
# the data file in which the histogram is stored (pedestals_noise_hist.csv)
...
if __name__ == '__main__':
    ...
    # Plot data
    n, bins1, patches = plt.hist(bins, len(bins), weights=data, histtype='stepfilled', linewidth=2, label="Data", color=dataColor)
